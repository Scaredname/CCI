...
parser.add_argument(
    ...
    help="If use pre-trained type embeddings, the name of pretained model",
)
...
pipeline_result.configuration["num_parameter_bytes"] = (
    str(model.num_parameter_bytes / 125000) + "MB"
)
...
if args.model_index in [51, 52, 71, 72]:
