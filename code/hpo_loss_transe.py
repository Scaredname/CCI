...
if __name__ == "__main__":
    ...
    loss_kwargs_ranges = dict(
        margin=dict(type=int, low=6, high=20, q=2),
        adversarial_temperature=dict(type=float, low=1, high=3, q=0.5),
    ...
    negative_sampler_kwargs_ranges = dict(
        num_negs_per_pos=dict(type=int, scale="power_two", low=6, high=9)
    )
